...
struct FAFlight: Codable, Hashable, Identifiable, Comparable, CustomStringConvertible
{
    ...
    //sun
    // Comparable : useful for sorting flights
    // array method sorted works without any arguments when comparable is implemented
    ...
    // custom what happens when "\(FAFlight)" happens
