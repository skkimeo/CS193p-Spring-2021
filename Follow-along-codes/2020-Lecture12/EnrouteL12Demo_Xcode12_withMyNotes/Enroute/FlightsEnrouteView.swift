...
struct FlightsEnrouteView: View {
    // sun
    // this is required to pass the same context into sheet
    // which is needed for the fetchrequest to work 
...
struct FlightList: View {
    ...
    init(_ flightSearch: FlightSearch) {
        ...
        // sun
        // constantly updated to sync the change in the database(e.g. addition, delete, modification etc.)
